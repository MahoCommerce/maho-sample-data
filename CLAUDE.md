...
- Pictures: `wavespeed-ai/krea-v2/turbo` on NanoGPT (0.010 USD per picture) for every tier, chosen in a bake-off against flux-2-klein-9b, z-image-turbo and microsoft/mai-image-2.5. Fallback: `flux-2-klein-9b`. The store pack (hero and tiles) uses `gpt-image-2` (0.05 to 0.07 USD per picture).
